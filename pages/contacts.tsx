    ...
    <MainLayout>
      <BlockWrapper title="Контакты">
        <div className={styles["wrapper"]}>
          ...
          >
            <img
              src={`https://maps.googleapis.com/maps/api/staticmap?&markers=size:mid%7Ccolor:red%7C48.4739688,32.1979463&zoom=15&size=734x307&key=${process.env.GOOGLE_MAP_API_KEY}`}
              alt="map"
              // width="734"
              // height="307"
            />
